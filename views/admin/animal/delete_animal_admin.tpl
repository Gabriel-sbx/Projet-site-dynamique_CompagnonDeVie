...
<div class="col-md-5">
  <div class="py-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h4 class="text-right">Supprimez L'animal</h4>
    </div>
    ...
    <form action="" method="post">
      <div class="row mt-2">
        <div data-mdb-input-init class="form-outline mb-4">
          <p>
            Êtes-vous sûr de vouloir supprimer cet animal ? Cette action est
            irréversible et entraînera la perte de toutes les données.
          </p>
        </div>
        <div class="col-md-6">
          <p>
            <label for="verifDelete" class="labels"
              ><h5>
                Inscrire <strong>"SUPPRIMER"</strong> dans le champ pour
                confirmer
              </h5></label
            >
          </p>
