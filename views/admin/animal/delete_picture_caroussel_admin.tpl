...
<div class="col-md-5">
  <div class="py-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h4 class="text-right">Supprimez L'image du caroussel de l'animal</h4>
    </div>
    ...
    <form action="" method="post">
      <div class="row mt-2">
        <div data-mdb-input-init class="form-outline mb-4">
          <p>
            Êtes-vous sûr de vouloir l'image du caroussel de cet animal ? Cette
