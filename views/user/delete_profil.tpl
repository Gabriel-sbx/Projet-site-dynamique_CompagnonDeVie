    ...
    <div class="col-md-5 ">
        <div class=" py-5">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="text-right">Supprimez votre compte</h4>
            </div>
            {include file='views/_partial/messages.tpl'}
            <form action="" method="post">
                <div class="row mt-2">
                <div data-mdb-input-init class="form-outline mb-4">	
                    <p>Êtes-vous sûr de vouloir supprimer ce compte ? Cette action est irréversible et entraînera la perte de toutes les données.</p>				
                </div>
                <div class="col-md-6">
                ...
                <div class="mt-5 text-center">
                    <button class="btn btn-success profile-button" type="submit">Supprimez le compte</button>
                </div>
            </form>
        </div>
    </div>
